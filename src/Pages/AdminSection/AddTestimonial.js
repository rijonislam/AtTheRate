                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <h3 className='mt-5'> Update Testimonial Text </h3>
                        {
                            ...
                            <>
                                {testimonialtext.map(text =>
                                    <Link className='template-btn' to={`/testimonialtext-edit/${text._id}`}> Update Now</Link>
                                )}
                            </>
                        }
                            ...
                            <form class="contact-form " onSubmit={handleTestimonialSection}>
                                <div class="row">
                                    ...
                                    <div class="slider-btn">
                                        <button class="template-btn" data-animation="fadeInRight" data-delay=".8s"> Update Testimonial Text </button>
                                    </div>
                                </div>
                        ...
                        <form class="contact-form " onSubmit={handleStepSection}>
                            <div class="row">
                                ...
                                <div class="slider-btn">
                                    <button class="template-btn" data-delay=".8s"> Add Testimonial</button>
                                </div>
                            </div>
